...
public class CommonController {
    ...
    /**
     * This class handles the endpoint that is accessible by all signed in user
     * ie to gives user profiles for the specified user.
     *
     * This class depends on UserProfileBusinessService class and is autowired and hence
     * instantiated by Spring Framework for us.
     */
    ...
    public ResponseEntity<UserDetailsResponse> getUser(@PathVariable("userId") final String userUuid,
        ...
        //userProfileBusinessService business service's getUserProfile method is called to
        // run the business logic of getting user profile info for particular user from database.
        // It passes following as parameters:
